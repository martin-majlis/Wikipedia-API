"""Non-blocking HTTP client built on httpxyz.AsyncClient.

Creates a persistent httpxyz.AsyncClient at construction time and
...
class AsyncHTTPClient(BaseHTTPClient):
    ...
    :attr _client: underlying ``httpxyz.AsyncClient`` instance
    """

"""Blocking HTTP client built on httpxyz.Client.

Creates a persistent httpxyz.Client at construction time and uses
...
class SyncHTTPClient(BaseHTTPClient):
    ...
    :attr _client: underlying ``httpxyz.Client`` instance
    """
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        ``httpxyz.Client`` with the computed headers and timeout.
        ...
        self._client = httpxyz.Client(
            ...
            **self._client_kwargs,
            transport=httpxyz.HTTPTransport(),
        )

...
class TestParamsCoverage:
    ...
    def test_base_params_bool_true(self):
        ...
        params = _BaseParams()
        params.test_bool = True  # ty: ignore[unresolved-attribute]
    ...
    def test_base_params_bool_false(self):
        ...
        params = _BaseParams()
        params.test_bool = False  # ty: ignore[unresolved-attribute]
        params.FIELD_MAP = {"test_bool": "test_bool"}  # ty: ignore[invalid-attribute-access]
        result = params.to_api()
    ...
    def test_base_params_enum_handling(self):
        ...
        params = _BaseParams()
        params.test_enum = TestEnum.VALUE  # ty: ignore[unresolved-attribute]
    ...
    def test_coordinates_params_invalid_type(self):
        ...
        with pytest.raises(TypeError) as excinfo:
            CoordinatesParams(primary=123, prop=[])  # ty: ignore[invalid-argument-type]
    ...
    def test_geosearch_params_invalid_sort(self):
        ...
        with pytest.raises(TypeError) as excinfo:
            GeoSearchParams(coord=GeoPoint(lat=51.5, lon=-0.1), sort=123)  # ty: ignore[invalid-argument-type]
    ...
    def test_geosearch_params_invalid_globe(self):
        ...
        with pytest.raises(TypeError) as excinfo:
            GeoSearchParams(coord=GeoPoint(lat=51.5, lon=-0.1), globe=123)  # ty: ignore[invalid-argument-type]
    ...
    def test_geosearch_params_invalid_primary(self):
        ...
        with pytest.raises(TypeError) as excinfo:
            GeoSearchParams(coord=GeoPoint(lat=51.5, lon=-0.1), primary=123)  # ty: ignore[invalid-argument-type]
    ...
    def test_random_params_invalid_filter(self):
        ...
        with pytest.raises(TypeError) as excinfo:
            RandomParams(filter_redirect=123)  # ty: ignore[invalid-argument-type]
    ...
    def test_search_params_invalid_sort(self):
        ...
        with pytest.raises(TypeError) as excinfo:
            SearchParams(sort=123)  # ty: ignore[invalid-argument-type]
